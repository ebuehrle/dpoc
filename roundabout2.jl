...
@constraint m [i=1:length(φ)] Mom.(differentiate(φ[i],t) + differentiate(φ[i],x)'*f + tr(Diagonal([3e-3,3e-3,3e-2,3e-2])*differentiate(differentiate(φ[i],x),x)), μ) == Mom.(φ[i], μT-μ0)
